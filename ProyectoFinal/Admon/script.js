...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de Administracion, si quieres saber sobre ella prueba diciendo "Administracion" o "Iniciar"');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Licenciatura administracion.' || voz === 'Administracion.' || voz === 'Admon.'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('El Programa académico fue acreditado desde el 27 de marzo de 2018 por el Consejo de Acreditación en Ciencias Administrativas, Contables y Afines (CACECA). Esta carrera se encarga de la organización interna de una empresa, utilizando métodos y prácticas organizacionales, que permitan la gestión de sociedades mercantiles');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
