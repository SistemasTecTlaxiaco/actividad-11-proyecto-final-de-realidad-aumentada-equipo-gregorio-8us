...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de Gestion empresarial, si quieres saber sobre ella prueba diciendo "Gestion" o "Iniciar"');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Ingenieria en Gestion' || voz === 'Gestion Empresarial' || voz === 'Gestion'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('El programa academico de IGE fue acreditado el 27 de abril del 2018 por el consejo de acreditacion en ciencias administraticas, contables y afines o CACECA. El objetivo es formar integralmente profesionales que contribuyan a la gestion de empresas e innovacion de procesos, asi como el diseño, implementacion y desarrollo de sistemas estrategicos de negocios , optimizando recursos en un entorno global, con etica y responsabilidad social');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
