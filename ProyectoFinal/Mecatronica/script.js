...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de mecatronica, si quieres saber sobre ella prueba diciendo "Mecatronica" o "Iniciar"');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Mecatronica.' || voz === 'Meca' || voz === 'Inicia la explicación.'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('Oh perfecto!, La carrera de ingenieria en mecatronica es de las mas complejas contando con nueve semestres, de los cuales ocho son de estudio y el noveno es de residencia profrecional. Cabe recalcar que esta carrera fue fundada en el 2010 y comenzo con 31 estudiantes');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
