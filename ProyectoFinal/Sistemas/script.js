...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var voces = ['Hola', 'Inicia', 'Pausa explicación', 'Reinicia explicación'];
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de sistemas, si quieres saber sobre ella prueba diciendo "Sistemas" o "Iniciar"');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Ingenieria en sistemas.' || voz === 'ISC.' || voz === 'Sistemas.'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('La carrera de ISC fue fundada en 1998 dando inicio con 51 estudiantes y esta compuesta por 9 semestres y especializada en el desarrollo de software');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
