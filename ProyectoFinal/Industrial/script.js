...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de Ingenieria Industrial, si quieres saber sobre ella prueba diciendo "Industrial" o "Iniciar"');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Industrial' || voz === 'Ingenieria indutrial.' || voz === 'Inicia la explicación.'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('La carrera de Ingenieria Industrial tenia como nombre Licenciatura en administracion industrial con una matricula de 50 estudiantes, es importante recalcar que fue fundada en 1991 siendo una de las primeras carreras de nuestra institucion');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
