...
document.addEventListener('DOMContentLoaded', function() {
  ...
  recognition.onresult = function (event) {
      ...
      if (voz === 'Hola.') {
          ...
          let utterance = new SpeechSynthesisUtterance('Hola, se bienvenido a la carrera de civil, si quieres saber sobre ella prueba diciendo "Civil" o "Iniciar".');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
      ...
      if (voz === 'Ingenieria civil.' || voz === 'Civil.' || voz === 'Inicia la explicación.'|| voz === 'Iniciar.') {
        console.log("Iniciando la explicación!");
        let utterance = new SpeechSynthesisUtterance('La carrera de ingenieria civil es de las mas grandes, fue fundada en el 2012 con 81 estudiantes, esta carrera cuenta con 8 semestres de estudio y el ultimo de residencia profesional');
        diagnostic.setAttribute("value", "Dijiste: " + voz + ".");
        utterance.lang = 'es-MX'
